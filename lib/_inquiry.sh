...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Whaticket SaaS 4.5v, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar Whaticket SaaS 4.5v \n"
  # printf "   [1] Atualizar Whaticket SaaS \n"
  printf "   [2] Deletar Whaticket SaaS 4.5v \n"
  printf "   [3] Bloquear Whaticket SaaS 4.5v \n"
  printf "   [4] Desbloquear Whaticket SaaS 4.5v \n"
  printf "   [5] Alter. dominio Whaticket SaaS 4.5v \n"
  printf "\n"
  read -p "> " option
